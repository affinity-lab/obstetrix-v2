...
export {
  ...
  set_component_context as X,
  Batch as Y,
  handle_error as Z,
  active_reaction as _,
  attr_class as a,
  internal_set as a0,
  destroy_effect as a1,
  invoke_error_boundary as a2,
  svelte_boundary_reset_onerror as a3,
  HYDRATION_START_FAILED as a4,
  svelte_boundary_reset_noop as a5,
  EFFECT_TRANSPARENT as a6,
  EFFECT_PRESERVED as a7,
  define_property as a8,
  init_operations as a9,
  get_first_child as aa,
  hydration_failed as ab,
  clear_text_content as ac,
  component_root as ad,
  array_from as ae,
  is_passive_event as af,
  push as ag,
  pop as ah,
  set as ai,
  LEGACY_PROPS as aj,
  flushSync as ak,
  mutable_source as al,
  render as am,
  stringify as b,
  escape_html as c,
  attr as d,
