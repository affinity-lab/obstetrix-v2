import { w as with_request_store, t as text_decoder, b as base64_decode, r as root, d as decode_pathname, n as normalize_path, a as disable_search, c as decode_params, v as validate_layout_server_exports, e as validate_layout_exports, f as validate_page_server_exports, g as validate_page_exports, h as text_encoder$1, i as resolve, m as make_trackable, j as get_relative_path, k as base64_encode } from './chunks/root-BkPoLMvS.js';
import { an as DevalueError, ao as is_primitive, ap as get_type, aq as is_plain_object, ar as enumerable_symbols, as as stringify_key, at as stringify_string, au as valid_array_indices, av as BROWSER, aw as uneval } from './chunks/renderer-Dl7nK692.js';
import { w as writable, r as readable } from './chunks/index2-DtXBls1V.js';
...
function create_remote_arg_revivers(transport) {
  const remote_fns_revivers = {
    ...
    [remote_map]: (value) => {
      ...
      for (const item of value) {
        ...
        const [key, val] = item;
        map.set(parse$1$1(key), parse$1$1(val));
      }
      return map;
    },
  ...
  const parse$1$1 = (data) => parse$1(data, all_revivers);
  return all_revivers;
}
function parse_remote_arg(string, transport) {
  ...
  return parse$1(json_string, create_remote_arg_revivers(transport));
}
...
async function get_hooks() {
  ...
  let init;
  ({ handle, handleFetch, handleError, handleValidationError, init } = await import('./chunks/hooks.server-CwS-4fZ0.js'));
  let reroute;
  let transport;
  return {
    handle,
