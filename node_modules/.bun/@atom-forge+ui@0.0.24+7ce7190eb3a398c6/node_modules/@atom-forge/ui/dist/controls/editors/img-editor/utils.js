export function makeDefaultImgEditorData(src) {
    return {
        src,
        steps: [],
...
export function computeSmartCrop(focal, safe, targetAspect, imgAspect) {
    ...
    function axis(focus, crop, safeStart, safeSize) {
...
export function computeInscribedRect(w, h, deg) {
...
export async function applyStepToBitmap(source, step) {
...
export async function applyChainToBitmap(original, steps) {
    if (steps.length === 0)
        return original;
