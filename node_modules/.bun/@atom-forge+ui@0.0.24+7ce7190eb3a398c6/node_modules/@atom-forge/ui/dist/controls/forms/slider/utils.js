import { THUMB_SIZES } from './theme';
export function getPercentage(val, min, max, trackEl, size) {
...
export function getValueFromClientX(clientX, min, max, step, trackEl, size, round = true) {
    const thumbSizeRem = THUMB_SIZES[size];
    const thumbSizePx = thumbSizeRem * 16; // Assuming 1rem = 16px
