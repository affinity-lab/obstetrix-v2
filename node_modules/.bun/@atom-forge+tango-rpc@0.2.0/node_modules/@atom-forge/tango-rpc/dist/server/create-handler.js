...
function flattenApiDefinition(apiDefinition) {
    const map = new Map();
 ...
 */
export function createHandler(apiDefinition, options) {
    const createServerContext = options?.createServerContext ||
        ((args, event) => new ServerContext(args, event));
 ...
 */
function makeResponse(result, ctx) {
